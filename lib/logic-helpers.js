...
Template.registerHelper("is", (...args) => compareLeft(args, (a, b) => a === b));

// Return whether each argument is greater than the previous
Template.registerHelper("gt", (...args) => compareLeft(args, (a, b) => a > b));

// Return whether each argument is less than the previous
Template.registerHelper("lt", (...args) => compareLeft(args, (a, b) => a < b));

// Return whether value is in array
Template.registerHelper("in", (...args) => compareLeft(args, a => _.contains(args[0], a)));

// Return the second or third argument depending on the first
Template.registerHelper("tern", (...args) => {
  popkw(args);
